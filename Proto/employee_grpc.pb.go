...
type EmployeeServiceClient interface {
	...
	DeleteEmployee(ctx context.Context, in *EmployeeIdRequest, opts ...grpc.CallOption) (*DeleteResponse, error)
}
...
func (c *employeeServiceClient) GetEmployee(ctx context.Context, in *EmployeeIdRequest, opts ...grpc.CallOption) (*Employee, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Employee)
...
func (c *employeeServiceClient) DeleteEmployee(ctx context.Context, in *EmployeeIdRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type EmployeeServiceServer interface {
	...
	DeleteEmployee(context.Context, *EmployeeIdRequest) (*DeleteResponse, error)
...
func (UnimplementedEmployeeServiceServer) GetEmployee(context.Context, *EmployeeIdRequest) (*Employee, error) {
...
func (UnimplementedEmployeeServiceServer) DeleteEmployee(context.Context, *EmployeeIdRequest) (*DeleteResponse, error) {
...
func _EmployeeService_GetEmployees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).GetEmployees(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EmployeeService_GetEmployee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).GetEmployee(ctx, req.(*EmployeeIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EmployeeService_DeleteEmployee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).DeleteEmployee(ctx, req.(*EmployeeIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
